        ...
        <div className="flex justify-between items-center">
          ...
          {/* <div className="hidden md:flex space-x-4 items-center"> */}
            ...
            <div className="md:flex hidden md:items-center space-x-4">
              ...
              <NavLink href="/cart"><button className="text-amber-800 hover:text-amber-600">
          ...
          <button onClick={() => setIsOpen(!isOpen)} className="md:hidden">
            <svg className="w-6 h-6 text-amber-800" fill="none" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" viewBox="0 0 24 24" stroke="currentColor">
